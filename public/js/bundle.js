...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW5zaGlrYTQ1MSIsImEiOiJja2RnZmpqZjMwNnk2MnBvYjlxNHQ1bHFyIn0.pT1d5t6GxXK-yHSHcyO9qQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/anshika451/ckdgfytqw06sh1il45twuprhv',
    scrollZoom: false
  });
...
var stripe = Stripe('pk_test_51HCpmIK8woMGizWIdD56T3DnzqYSsqw7RZwB7yWKVRofpPuoo4aOoIGi7AmSDxk2wDtHUX20vYgoHwneS7Gm146n00Woex9ESC');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            console.log('updated');
            _context.next = 4;
            return (0, _axios.default)("http://127.0.0.1:8000/api/v1/bookings/checkout-session/".concat(id));
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  var tourId = e.target.dataset.tourId; // console.log(e.target.dataset);
